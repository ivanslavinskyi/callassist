...
- Extend the localized CMS Core (drafts, EN/DE preview, immutable publish/history,
  rollback and legal re-acceptance) with structured navigation and SEO controls.
