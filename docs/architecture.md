...
- Twilio: исходящий PSTN-звонок, подписанные webhooks и, на следующем шаге, двунаправленный Media Stream.
