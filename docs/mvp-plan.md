...
Текущий статус: пульт без телефонии завершён; PostgreSQL, шифрование и audit trail из серверной основы реализованы. Redis/BullMQ отложены до появления реальных фоновых звонков.
