...
| R08 / P0 | Partial — backend/safety | Immutable plans, exact original/translation review receipts, fenced attempts and full-plan moderation are implemented. Preapproved facts may be used as needed; additional live permission prompts are excluded. The 2026-09-10 extension adds explicit permission to book or confirm one bounded appointment with the called recipient. Rescheduling, cancellation, payment, deposits and new financial/cancellation terms remain prohibited; runtime acceptance is pending | Prove adherence to approved facts and appointment limits under adversarial requests, ambiguous date/time, false confirmations and stop cases; check the single-action gate and recipient-confirmed result, then record authorized live evidence. A successful permission check is not a booking. Repository/UI/copy changes alone do not close voice safety acceptance |
