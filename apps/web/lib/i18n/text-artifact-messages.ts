...
export const textArtifactMessages = {
  en: {
    ...
    nextSteps: "Next steps", unresolved: "Still unclear", evidence: "Source", sources: "Sources", allFindings: "All findings", reported: "Reported in the call",
    ...
    rateLimited: "Too many text requests. Please try again later.",
    retryUnavailable: "The translation could not be prepared and cannot be retried. The original is shown below.",
    reviewRetryUnavailable: "The translation could not be prepared and cannot be retried. You can choose the original to review the plan.",
    summaryRetryUnavailable: "The call result could not be prepared and cannot be retried. You can read the transcript below.",
  ...
  de: {
    ...
    nextSteps: "Nächste Schritte", unresolved: "Noch unklar", evidence: "Quelle", sources: "Quellen", allFindings: "Alle Ergebnisse", reported: "Im Gespräch genannt",
    ...
    rateLimited: "Zu viele Textanfragen. Bitte versuchen Sie es später erneut.",
    retryUnavailable: "Die Übersetzung konnte nicht erstellt werden. Ein erneuter Versuch ist nicht möglich. Das Original wird unten angezeigt.",
    reviewRetryUnavailable: "Die Übersetzung konnte nicht erstellt werden. Ein erneuter Versuch ist nicht möglich. Sie können das Original zur Prüfung des Plans wählen.",
    summaryRetryUnavailable: "Das Gesprächsergebnis konnte nicht erstellt werden. Ein erneuter Versuch ist nicht möglich. Sie können unten das Transkript lesen.",
