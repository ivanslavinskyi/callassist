...
const en = {
  ...
  exportText: "Create a versioned JSON file containing the account data currently available to you in SHPROHLI.",
  exportIncludes: [
  ...
  deletionText: "This starts a durable deletion request. SHPROHLI first removes provider recordings and private call content, then anonymizes your identity and signs out every device.",
...
const de: AccountMessages = {
  ...
  exportText: "Erstellen Sie eine versionierte JSON-Datei mit den Kontodaten, die Ihnen derzeit in SHPROHLI zur Verfügung stehen.",
  exportIncludes: [
  ...
  deletionText: "Damit starten Sie einen dauerhaften LÃ¶schauftrag. SHPROHLI entfernt zuerst Aufzeichnungen beim Anbieter und private Anrufinhalte, anonymisiert danach Ihre IdentitÃ¤t und meldet alle GerÃ¤te ab.",
