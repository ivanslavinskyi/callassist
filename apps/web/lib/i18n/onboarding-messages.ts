...
const en = {
  ...
  intro: "SHPROHLI places real phone calls. Confirm the current legal versions and the operational safeguards before entering the call console.",
  ...
  useLimits: "I will use SHPROHLI only for legitimate low-risk tasks and never for emergencies, harassment, deception, spam, or high-stakes negotiation.",
  ...
  submit: "Accept and open SHPROHLI",
...
const de: OnboardingMessages = {
  ...
  intro: "SHPROHLI führt echte Telefonanrufe durch. Bestätigen Sie die aktuellen rechtlichen Versionen und Schutzmechanismen, bevor Sie die Anrufkonsole öffnen.",
  ...
  useLimits: "Ich nutze SHPROHLI nur für legitime Aufgaben mit geringem Risiko und nie für Notfälle, Belästigung, Täuschung, Spam oder Verhandlungen mit hohem Risiko.",
  ...
  submit: "Akzeptieren und SHPROHLI öffnen",
