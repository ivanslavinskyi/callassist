...
export const callActivityMessages: Record<UiLocale, ActivityCopy> = extendMessages({
  en: {
    ...
    connected: { label: "Call connected", title: (name: string) => `Connected to ${name}`, help: "The transcript will appear here after the recipient agrees to the conversation." },
  ...
  de: {
    ...
    connected: { label: "Verbindung hergestellt", title: (name: string) => `Mit ${name} verbunden`, help: "Das Transkript erscheint hier, sobald die angerufene Person dem Gespräch zustimmt." },
