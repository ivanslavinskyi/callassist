...
const enFormCopy = {
  ...
  profileNameHelp: "Names are filled from your profile. You can edit them for this call without changing your profile.",
...
const en: Messages = {
  ...
  live: {
    ...
    feedbackEyebrow: "Call quality",
    feedbackTitle: "Your feedback",
    feedbackHelp: "Tell us how the call went and how accurate the transcript is.",
...
const de: Messages = {
  ...
  form: {
    ...
    copy: {
      ...
      profileNameHelp: "Die Namen werden aus Ihrem Profil übernommen. Sie können sie für diesen Anruf ändern, ohne Ihr Profil zu ändern.",
  ...
  live: {
    ...
    feedbackEyebrow: "Anrufqualität",
    feedbackTitle: "Ihr Feedback",
    feedbackHelp: "Wie ist der Anruf verlaufen und wie genau ist das Transkript?",
