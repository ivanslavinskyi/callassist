...
const enFormCopy = {
  ...
  representedPersonPlaceholder: "e.g. John Doe",
...
const en: Messages = {
  ...
  form: {
    ...
    phoneValid: "Valid international number",
    phoneInvalid: "Use international format, for example +41710000000",
  ...
  live: {
    ...
    structuredTranscriptNote: "The wording comes only from one complete-recording pass. Roles and approximate timestamps are aligned from the live event scaffold; live draft words are never copied. A ? marks a speaker that could not be assigned safely.",
...
const de: Messages = {
  ...
  form: {
    ...
    phoneValid: "Gültige internationale Nummer",
    phoneInvalid: "Verwenden Sie das internationale Format, zum Beispiel +41710000000",
    ...
    copy: {
      ...
      representedPersonPlaceholder: "z. B. Max Mustermann",
  ...
  live: {
    ...
    structuredTranscriptNote: "Der Wortlaut stammt nur aus einem Durchlauf der vollständigen Aufnahme. Rollen und ungefähre Zeitangaben werden anhand der Live-Ereignisse ausgerichtet; Wörter aus dem Live-Entwurf werden nie kopiert. Ein ? kennzeichnet eine Stimme, die nicht sicher zugeordnet werden konnte.",
