...
export const publicReleaseCopy = {
  en: {
    consent: "SHPROHLI identifies itself as an AI assistant and asks the recipient whether the conversation may be recorded and transcribed. Their answer is processed by AI to recognise the choice. The main conversation and recording start only after consent.",
    control: "Before the call, you review the plan and the information the assistant may share. During the conversation, SHPROHLI uses that information as needed. You can follow the transcript and stop the call.",
    missingInformation: "The assistant is instructed to use the information approved before the call and to ask for clarification or explain when information is missing. AI conversations can contain errors.",
    appointments: "With your explicit approval of the service and date/time limits, SHPROHLI may either book or confirm one appointment with the called recipient. Confirming an existing appointment requires its exact date and time. A new booking uses the first offered time that meets your limits. Rescheduling, cancellations, payments, deposits and new financial or cancellation terms are excluded. The recipient must confirm the appointment during the call; a proposed time alone is not a confirmed booking. SHPROHLI has no access to the recipient's calendar.",
  ...
  de: {
    consent: "SHPROHLI stellt sich als KI-Assistent vor und fragt, ob das Gespräch aufgezeichnet und transkribiert werden darf. Die Antwort wird durch KI verarbeitet, um die Entscheidung zu erkennen. Das eigentliche Gespräch und die Aufzeichnung beginnen erst nach der Zustimmung.",
    control: "Vor dem Anruf prüfen Sie den Plan und die Angaben, die der Assistent weitergeben darf. Während des Gesprächs nutzt SHPROHLI diese Angaben nach Bedarf. Sie können das Transkript verfolgen und den Anruf beenden.",
    missingInformation: "Der Assistent ist angewiesen, die vor dem Anruf freigegebenen Angaben zu verwenden und bei fehlenden Informationen nachzufragen oder darauf hinzuweisen. KI-Gespräche können Fehler enthalten.",
    appointments: "Mit Ihrer ausdrücklichen Freigabe der Leistung und der Zeitfenster kann SHPROHLI bei der angerufenen Stelle entweder einen Termin vereinbaren oder einen bestehenden Termin bestätigen. Für die Bestätigung eines bestehenden Termins sind das genaue Datum und die Uhrzeit erforderlich. Bei einer neuen Buchung wird der erste angebotene Termin gewählt, der zu Ihren Vorgaben passt. Verschieben, Absagen, Zahlungen, Anzahlungen sowie neue finanzielle Bedingungen oder Stornogebühren sind ausgeschlossen. Die angerufene Person muss den Termin im Gespräch bestätigen; ein Vorschlag allein ist keine bestätigte Buchung. SHPROHLI hat keinen Zugriff auf deren Kalender.",
    credits: "Beim Start wird ein Anrufguthaben reserviert. Es wird erst verbraucht, wenn die angerufene Person zugestimmt und inhaltlich auf Ihr Anliegen geantwortet hat. Auch eine sachlich negative Antwort, Nichtwissen oder der Verweis an eine andere Stelle zählt. Eine Verbindung, Begrüssung, Stille oder sofortige Gesprächsverweigerung allein verbraucht kein Guthaben. Wird keine inhaltliche Antwort bestätigt, erhalten Sie das Guthaben nach Anrufende zurück. Das Anliegen muss nicht gelöst sein. Während der Beta gibt es keine Zahlungen."
  }
} as const;
    ...
    translations: {
      en: {
        ...
        sections: [
          ...
          section("12. Effective date", "The version and effective date shown above identify the Privacy Notice that is currently published.")
        ]
      },
      de: {
        slug: "datenschutz",
        ...
        sections: [
          ...
          section("6. Dienstleister und internationale Bearbeitung", "Twilio stellt Telefonie und SMS-Bestätigung bereit. OpenAI verarbeitet Anrufvorbereitung, Zustimmungserkennung, KI-Gespräche und Transkription. Wenn Übersetzungen oder Zusammenfassungen freigeschaltet sind, verarbeitet OpenAI dafür auch den jeweiligen Plan oder das Originaltranskript. Resend versendet Konto-E-Mails mit der Empfängeradresse und dem Nachrichteninhalt; Gesprächsaufnahmen und Transkripte sind darin nicht enthalten. Diese Anbieter bearbeiten die für ihren Dienst erforderlichen Daten und können dies ausserhalb der Schweiz tun. Für die internationale Bearbeitung verwenden wir Vereinbarungen und Schutzmassnahmen zum Schutz von Personendaten."),
          section("7. Aufbewahrung", "Für jeden Anruf wählen Sie eine Audioaufbewahrung: Aufnahme nach Erstellung des Endtranskripts löschen, 7 Tage aufbewahren oder 30 Tage aufbewahren. Auch die erste Option umfasst eine vorübergehende Aufnahme; das Transkript wird dabei nicht gelöscht. Übersetzungen und Zusammenfassungen verlängern die Audioaufbewahrung nicht. Andere Konto- und Anrufdaten, einschliesslich gespeicherter Übersetzungen und Zusammenfassungen bei freigeschalteten Funktionen, werden so lange gespeichert, wie dies für den Dienst, Ihre Einstellungen, den Schutz des Dienstes oder anwendbare Pflichten erforderlich ist."),
          ...
          section("12. Gültig ab", "Version und Datum oberhalb des Dokuments bezeichnen die aktuell veröffentlichte Fassung dieser Datenschutzhinweise.")
        ]
      }
    }
  },
    ...
    translations: {
      en: {
        ...
        sections: [
          ...
          section("3. What the service does", `${publicReleaseCopy.en.control} ${publicReleaseCopy.en.consent} SHPROHLI can show a live transcript and create a final transcript after the call. ${publicReleaseCopy.en.appointments}`),
          ...
          section("5. Beta credits and availability", `The beta includes three promotional call credits. ${publicReleaseCopy.en.credits} Supported destinations, languages, limits, features and availability may change during the beta.`),
      ...
      de: {
        ...
        summary: "Diese Bedingungen gelten, wenn Sie ein SHPROHLI-Konto erstellen und die Beta nutzen.",
        seoTitle: "Nutzungsbedingungen | SHPROHLI",
        seoDescription: "Verständliche Bedingungen für die Nutzung der SHPROHLI-Beta.",
        sections: [
          section("1. Über SHPROHLI", "SHPROHLI ist ein Beta-Dienst für legitime, risikoarme Alltagstelefonate. Zugang und Anrufverfügbarkeit können während der Erprobung eingeschränkt sein. Der Dienst hilft Menschen beim Telefonieren, wenn das Sprechen oder die lokale Sprache eine Hürde ist. SHPROHLI ist weder ein Notfalldienst noch ein Ersatz für rechtliche, medizinische oder finanzielle Fachberatung."),
          ...
          section("3. Funktionsweise des Dienstes", `${publicReleaseCopy.de.control} ${publicReleaseCopy.de.consent} SHPROHLI kann ein Live-Transkript anzeigen und nach dem Anruf ein Endtranskript erstellen. ${publicReleaseCopy.de.appointments}`),
          ...
          section("5. Beta-Guthaben und Verfügbarkeit", `Die Beta umfasst drei Anrufguthaben. ${publicReleaseCopy.de.credits} Unterstützte Ziele, Sprachen, Limiten, Funktionen und Verfügbarkeit können sich während der Beta ändern.`),
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        sections: [
          section("Supported use", ["Use SHPROHLI for legitimate, low-risk everyday calls where the recipient may reasonably be contacted.", publicReleaseCopy.en.appointments], ["Request routine information", "Ask about appointment times or documents, or explicitly authorise one appointment within your approved limits", "Ask whether a document arrived, request a form or check an application status", "Deliver a neutral everyday message"]),
          ...
          section("Consent and recording", `${publicReleaseCopy.en.consent} Do not attempt to bypass, pressure or mislead the recipient about this choice.`),
      ...
      de: {
        ...
        sections: [
          section("Unterstützte Nutzung", ["Nutzen Sie SHPROHLI für legitime, risikoarme Alltagstelefonate, bei denen die angerufene Person vernünftigerweise kontaktiert werden darf.", publicReleaseCopy.de.appointments], ["Routinemässige Informationen anfragen", "Nach Terminen oder Unterlagen fragen oder einen Termin innerhalb Ihrer Vorgaben ausdrücklich freigeben", "Nachfragen, ob ein Dokument angekommen ist, ein Formular anfordern oder den Stand eines Antrags prüfen", "Eine neutrale Alltagsnachricht übermitteln"]),
          ...
          section("Zustimmung und Aufnahme", `${publicReleaseCopy.de.consent} Versuchen Sie nicht, diese Entscheidung zu umgehen, zu erzwingen oder irreführend darzustellen.`),
    ...
    translations: {
      en: {
        ...
        sections: [
          ...
          section("How does the recipient give consent?", `${publicReleaseCopy.en.consent} SHPROHLI first asks verbally. If the answer cannot be understood reliably, the assistant may offer confirmation by keypad.`),
          ...
          section("What information can the assistant share?", `${publicReleaseCopy.en.control} The assistant is instructed to share concrete facts only from the approved objective and approved information. Background context alone does not authorise disclosure.`),
          section("What happens if the recipient asks an unexpected question?", publicReleaseCopy.en.missingInformation),
          ...
          section("Which calls and phone numbers are supported?", `The beta supports legitimate, low-risk everyday calls to valid Swiss destination numbers in the languages shown when you create a call. ${publicReleaseCopy.en.appointments}`),
          ...
          section("When is a call credit used?", publicReleaseCopy.en.credits)
        ]
      },
      de: {
        slug: "faq",
        ...
        sections: [
          ...
          section("Wie stimmt die angerufene Person zu?", `${publicReleaseCopy.de.consent} SHPROHLI fragt zuerst mündlich. Kann die Antwort nicht zuverlässig verstanden werden, kann der Assistent eine Bestätigung über die Telefontastatur anbieten.`),
          ...
          section("Welche Angaben darf der Assistent weitergeben?", `${publicReleaseCopy.de.control} Der Assistent ist angewiesen, konkrete Fakten nur aus dem freigegebenen Ziel und den freigegebenen Angaben weiterzugeben. Hintergrundinformationen allein erlauben keine Weitergabe.`),
          section("Was geschieht bei einer unerwarteten Rückfrage?", publicReleaseCopy.de.missingInformation),
          ...
          section("Welche Anrufe und Telefonnummern werden unterstützt?", `Die Beta unterstützt legitime, risikoarme Alltagstelefonate an gültige Schweizer Zielnummern in den Sprachen, die beim Erstellen eines Anrufs angeboten werden. ${publicReleaseCopy.de.appointments}`),
          ...
          section("Wann wird ein Anrufguthaben verbraucht?", publicReleaseCopy.de.credits)
        ]
      }
    }
  },
...
const landingBlocks: LandingBlock[] = [
  { id: "72000000-0000-4000-8000-000000000001", blockType: "hero", sortOrder: 0, enabled: true,
    ...
    title: localized("A phone call shouldn’t stand in your way.", "Ein Anruf sollte kein Hindernis sein."),
    lead: localized("When speaking is difficult or the local language is a barrier, SHPROHLI makes the call on your behalf.", "Wenn das Sprechen schwerfällt oder die lokale Sprache eine Hürde ist, übernimmt SHPROHLI den Anruf für Sie."),
    secondaryText: localized("Describe your task, review the plan and let the AI assistant speak for you. Follow the conversation in text and keep the answers afterwards.", "Beschreiben Sie Ihr Anliegen und prüfen Sie den Plan. Der KI-Assistent spricht für Sie. Sie lesen das Gespräch mit und haben die Antworten danach zum Nachschlagen."),
    badges: localizedList(["Free beta access", "3 call credits", "Calls to Swiss numbers"], ["Kostenloser Beta-Zugang", "3 Anrufguthaben", "Anrufe auf Schweizer Nummern"]),
    primaryCtaLabel: localized("Create an account", "Konto erstellen"), secondaryCtaLabel: localized("Try the demo", "Demo ausprobieren"),
  ...
  { id: "72000000-0000-4000-8000-000000000008", blockType: "problem", sortOrder: 4, enabled: true,
  ...
  { id: "72000000-0000-4000-8000-000000000003", blockType: "use_cases", sortOrder: 1, enabled: true,
    eyebrow: localized("EVERYDAY CALLS", "ALLTÄGLICHE TELEFONATE"), title: localized("What would you like to get done?", "Was möchten Sie erledigen?"), text: localized("Start with a question, a message or your own task. These are examples — you describe the goal and review what the assistant may say and do.", "Beginnen Sie mit einer Frage, einer Nachricht oder Ihrem eigenen Anliegen. Dies sind Beispiele: Sie beschreiben das Ziel und prüfen, was der Assistent sagen und tun darf."),
    items: [
      landingContentItem(21, "Can you repair my bike?", "Können Sie mein Velo reparieren?", "Ask a workshop about your model, appointment requirements and what to bring.", "Fragen Sie eine Werkstatt nach Ihrem Modell, ob ein Termin nötig ist und was Sie mitbringen sollen."),
      landingContentItem(22, "Which course would suit me?", "Welcher Kurs passt zu mir?", "Ask a course provider about levels, available places and accessibility. The provider answers your questions.", "Fragen Sie einen Kursanbieter nach Niveaus, freien Plätzen und Barrierefreiheit. Der Anbieter beantwortet Ihre Fragen."),
      landingContentItem(23, "Did my form arrive?", "Ist mein Formular angekommen?", "Check with your Gemeinde whether an application arrived, which documents are missing and how to send them.", "Klären Sie mit Ihrer Gemeinde, ob ein Antrag angekommen ist, welche Unterlagen fehlen und wie Sie diese einreichen können."),
      landingContentItem(24, "Can I book a time on Tuesday?", "Kann ich einen Termin am Dienstag buchen?", "Approve one booking within your chosen time window, or confirm an existing appointment. No rescheduling, cancellations or payments.", "Geben Sie eine Buchung in Ihrem Zeitfenster frei oder lassen Sie einen bestehenden Termin bestätigen. Kein Verschieben, Absagen oder Bezahlen."),
      landingContentItem(25, "Please let them know I’m late.", "Bitte sagen Sie Bescheid, dass ich später komme.", "Pass on a message, report a repair issue or ask someone to call you back.", "Übermitteln Sie eine Nachricht, melden Sie einen Reparaturbedarf oder bitten Sie um Rückruf."),
      landingContentItem(26, "I have something else to ask.", "Ich habe ein anderes Anliegen.", "Describe your own everyday task: who to call, what to ask and what information may be shared. You review the plan before the call.", "Beschreiben Sie Ihr eigenes Alltagsanliegen: wen wir anrufen, was wir fragen und welche Angaben wir weitergeben dürfen. Sie prüfen den Plan vor dem Anruf.") ] },
  { id: "72000000-0000-4000-8000-000000000009", blockType: "example", sortOrder: 3, enabled: true, title: localized("What would you like to ask?", "Worum geht es?"),
    items: [
  ...
  { id: "72000000-0000-4000-8000-000000000002", blockType: "how_it_works", sortOrder: 2, enabled: true,
    ...
    steps: [
      ...
      landingStep(4, "See what happened", "Sehen Sie das Ergebnis", "Follow the live transcript and review the final transcript afterwards.", "Verfolgen Sie das Live-Transkript und prüfen Sie danach das Endtranskript.") ] },
  { id: "72000000-0000-4000-8000-000000000004", blockType: "safety_privacy", sortOrder: 5, enabled: true,
    ...
    limits: localizedList([publicReleaseCopy.en.control, "The assistant identifies itself as AI and asks to record and transcribe the call. AI processes the reply to recognise consent. The main conversation and recording start after consent.", "AI conversations and transcripts can contain errors.", "You choose whether the recording is deleted after final transcription or kept for 7 or 30 days."], [publicReleaseCopy.de.control, "Der Assistent stellt sich als KI vor und fragt nach Zustimmung zur Aufnahme und Transkription. KI erkennt die Entscheidung anhand der Antwort. Erst nach Zustimmung beginnen das eigentliche Gespräch und die Aufnahme.", "KI-Gespräche und Transkripte können Fehler enthalten.", "Sie wählen, ob die Aufnahme nach dem Endtranskript gelöscht oder 7 beziehungsweise 30 Tage aufbewahrt wird."]) },
  { id: "72000000-0000-4000-8000-000000000005", blockType: "languages", sortOrder: 6, enabled: true,
    title: localized("Choose the language for your call.", "Wählen Sie die Sprache für Ihren Anruf."), text: localized("The website language does not determine the call language. Choose a supported language separately for each call.", "Die Sprache der Website bestimmt nicht die Sprache des Telefonats. Für jeden Anruf wählen Sie die passende unterstützte Sprache separat aus.") },
  { id: "72000000-0000-4000-8000-000000000006", blockType: "faq", sortOrder: 7, enabled: true, eyebrow: localized("Frequently asked questions", "Häufig gestellte Fragen"), title: localized("What happens when SHPROHLI makes a call?", "Was geschieht bei einem SHPROHLI-Anruf?"), itemLimit: 9 },
  { id: "72000000-0000-4000-8000-000000000007", blockType: "cta", sortOrder: 8, enabled: true, title: localized("One less call to put off.", "Ein Anruf weniger, den Sie aufschieben."), text: localized("Start with 3 free call credits. A credit is used only after the recipient agrees and gives a substantive answer about your task.", "Starten Sie mit 3 kostenlosen Anrufguthaben. Ein Guthaben wird erst nach Zustimmung und einer inhaltlichen Antwort auf Ihr Anliegen verbraucht."), primaryCtaLabel: localized("Create an account", "Konto erstellen") }
];
