    ...
    translations: {
      en: {
        ...
        sections: [
          ...
          section("3. What the service does", `${publicReleaseCopy.en.control} ${publicReleaseCopy.en.consent} SHPROHLI can show a live transcript and create a final transcript after the call. Appointment enquiries are limited to gathering information, not confirming a booking or making a commitment on your behalf.`),
      ...
      de: {
        ...
        sections: [
          ...
          section("3. Funktionsweise des Dienstes", `${publicReleaseCopy.de.control} ${publicReleaseCopy.de.consent} SHPROHLI kann ein Live-Transkript anzeigen und nach dem Anruf ein Endtranskript erstellen. Terminanfragen dienen der Auskunft; der Assistent bestätigt keine Buchung und macht keine verbindlichen Zusagen in Ihrem Namen.`),
  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        sections: [
          section("Supported use", "Use SHPROHLI for legitimate, low-risk everyday calls where the recipient may reasonably be contacted.", ["Request routine information", "Ask about available appointment times or which documents to bring; do not confirm a booking", "Ask whether a document arrived, request a form or check an application status", "Deliver a neutral everyday message"]),
    ...
    translations: {
      en: {
        ...
        sections: [
          ...
          section("Which calls and phone numbers are supported?", "The beta supports legitimate, low-risk everyday calls to valid Swiss destination numbers in the languages shown when you create a call. Appointment enquiries can ask about availability and required documents; the assistant does not confirm bookings."),
      ...
      de: {
        ...
        sections: [
          ...
          section("Welche Anrufe und Telefonnummern werden unterstützt?", "Die Beta unterstützt legitime, risikoarme Alltagstelefonate an gültige Schweizer Zielnummern in den Sprachen, die beim Erstellen eines Anrufs angeboten werden. Terminanfragen können verfügbare Zeiten und erforderliche Unterlagen klären; der Assistent bestätigt keine Buchungen."),
...
const landingBlocks: LandingBlock[] = [
  ...
  { id: "72000000-0000-4000-8000-000000000003", blockType: "use_cases", sortOrder: 2, enabled: true,
    ...
    items: [
      landingContentItem(21, "Doctor's practice", "Arztpraxis", "Ask about available appointment times or which documents to bring.", "Nach verfügbaren Terminen fragen oder klären, welche Unterlagen Sie mitbringen müssen."),
