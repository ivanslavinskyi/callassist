...
export const publicReleaseCopy = {
  en: {
    ...
    credits: "A credit is reserved when a call starts and used once the connection is confirmed, even if the recipient declines or the task remains unresolved. Unconnected attempts are refunded. No payments during the beta."
  },
  de: {
    ...
    credits: "Beim Start wird ein Anrufguthaben reserviert und nach bestätigter Verbindung verbraucht, auch wenn die angerufene Person ablehnt oder das Anliegen offen bleibt. Ohne Verbindung wird das Guthaben zurückgebucht. Während der Beta gibt es keine Zahlungen."
  }
} as const;
...
const landingBlocks: LandingBlock[] = [
  { id: "72000000-0000-4000-8000-000000000001", blockType: "hero", sortOrder: 0, enabled: true,
    ...
    badges: localizedList(["Beta access", "3 promotional call credits", "Swiss numbers only"], ["Beta-Zugang", "3 Anrufguthaben", "Nur Schweizer Nummern"]),
    primaryCtaLabel: localized("Try SHPROHLI", "SHPROHLI ausprobieren"), secondaryCtaLabel: localized("View an example", "Beispiel ansehen"),
  ...
  { id: "72000000-0000-4000-8000-000000000003", blockType: "use_cases", sortOrder: 2, enabled: true,
    ...
    items: [
      landingContentItem(21, "Doctor's practice", "Arztpraxis", "Ask about appointments and documents, or book one appointment within the limits you approve beforehand.", "Nach Terminen und Unterlagen fragen oder einen Termin innerhalb Ihrer vorab freigegebenen Vorgaben vereinbaren."),
      ...
      landingContentItem(24, "Landlord or repair service", "Vermieter oder Reparaturdienst", "Describe an issue and clarify the next practical step.", "Ein Problem schildern und den nächsten praktischen Schritt klären."),
  ...
  { id: "72000000-0000-4000-8000-000000000009", blockType: "example", sortOrder: 3, enabled: true, title: localized("An example, from request to answers", "Ein Beispiel: von der Anfrage zu den Antworten"),
    items: [
  ...
  { id: "72000000-0000-4000-8000-000000000007", blockType: "cta", sortOrder: 8, enabled: true, title: localized("A call you've been putting off?", "Schieben Sie einen Anruf schon länger vor sich her?"), text: localized(`Try SHPROHLI with three promotional call credits. ${publicReleaseCopy.en.credits}`, `Probieren Sie SHPROHLI mit drei Anrufguthaben aus. ${publicReleaseCopy.de.credits}`), primaryCtaLabel: localized("Create an account", "Konto erstellen") }
];
